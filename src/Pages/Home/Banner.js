        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className='text-center lg:text-left'>
                    ...
                    <p className="py-6">
                        Discover a wide range of Laptop accessories including Battery, Display, Keyboard at best price in Bangladesh.<br />Find your Computer and laptop Accessories Online. </p>
