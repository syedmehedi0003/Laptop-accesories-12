...
const ServiceDetail = () => {
  ...
  useEffect(() => {
    const url = `https://laptop-accesories1.onrender.com/product/${serviceId}`;
  ...
  const onSubmit = (data) => {
    ...
    const url = `https://laptop-accesories1.onrender.com/order`;
    console.log(url);
    fetch(url, {
      method: "POST",
      headers: {
      ...
      <div className="flex justify-center items-center">
        <div class="card w-96 bg-base-100 shadow-xl border ">
          <div class="card-body text-center">
            <h2 class="text-2xl font-bold ">Buy This Product</h2>
            <hr />
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              {!user && (
                <p className="text-red-500 font-bold">
                  <Link to="/login" className=" font-bold btn btn-ghost ">
                    First Login Here
                  </Link>
                </p>
              )}
