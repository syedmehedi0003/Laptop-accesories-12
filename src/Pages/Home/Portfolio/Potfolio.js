        ...
        <div>
            ...
            <div className="hero min-h-screen">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src={Myimg} className="lg:w-1/3 rounded-lg imgBorder sm:w-1/2" />
                    <div className='text-center lg:text-left'>
                        <h1 className="text-5xl font-bold">   I am Syed Mahade Hasan</h1>
                        <p className="py-6">
                        ...
                        <p className='text-lg mb-2'>I know Html, Css, JavaScript, React, NodeJs, MongoBD</p>
